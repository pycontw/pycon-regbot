...
def generate_already_used_token_embed():
    ...
    embed.set_footer(text=f"請您聯絡工作人員 @{THIS_YEAR}-staff \nPlease contact @{THIS_YEAR}-staff directly")
    return embed
...
def howto_in_registration_desk_embed():
    ...
    embed.set_footer(text=f"Note: \n你需要經過註冊後才能看到 PyCon APAC {THIS_YEAR} 的全部頻道 \nYou have to register first in order to enjoy all channels for PyCon APAC {THIS_YEAR}")
    return embed, f